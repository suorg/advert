$(document).ready(function () {
    ...
    function scrolling() {
        ...
        // сравниваем позицию скролла плюс высоты окна, относительно высоты всего документа
        // 500 - дополнительное значение в пикселях, для плавной загрузки, чтобы скролл не доходил до края документа
